...
<form name="form_insert" action="" method="post" id="form_insert">
    ...
    <h1 style="text-align:center;background-color:#ffd7d7"><?php _e('CREATE/EDIT INFORMAL INVOICE','wp-smart-crm-invoices-free')?> <i class="glyphicon glyphicon-list-alt"></i></h1>
    <div id="tabstrip">
        <ul>
        ...
        <div>
            <h4 class="page-header" style="margin: 10px 0 20px;">
                <?php _e('INVOICE DATA','wp-smart-crm-invoices-free')?><span class="crmHelp" data-help="document-data"></span>
                <?php if ($ID) {?>
...
/*
	...
	_informal.show("<?php _e("WARNING: you're working on an INFORMAL INVOICE","wp-smart-crm-invoices-free")?>", "error");
